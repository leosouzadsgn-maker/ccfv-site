...
(() => {
    ...
    const CHAMPIONS_CLUBS = [
        ["97762f56-2f71-4391-9740-82bf271eecaf","Real Madrid"],
        ["32829574-ddcd-4767-b2d3-550941cda564","Barcelona"],
        ["b9a26deb-a555-4068-a13a-a6caf70309fe","Atlético de Madrid"],
        ["ea34bb12-79b4-462a-b6f0-acd8daaf3f59","Manchester City"],
        ["d0e5285b-5a8c-4143-919e-a892835f9e9e","Manchester United"],
        ["d967a615-db1c-4ba6-9337-ad964bb087b9","Liverpool"],
        ["3e84811c-f238-4b91-a244-f9bd64eccccf","Arsenal"],
        ["f27adc91-8a5f-4374-9e2a-e0ff09535ffd","Chelsea"],
        ["cc7509a3-87b1-4a0d-9023-b8c115dac7fe","Inter de Milão"],
        ["390242ea-a560-4eca-804c-672c6b73a608","Milan"],
        ["09f4d9ee-9a55-45fb-95be-f01f3aee0e41","Juventus"],
        ["a5dde0fd-0d45-438a-b68e-c8aa342ca676","Napoli"],
        ["91a21c0d-1f21-4be4-8278-3043743cdae9","Roma"],
        ["6b7fdf57-6045-4513-a70e-59c557674657","Lazio"],
        ["5264fa12-513c-4ef9-9bd8-6d3be5e2c4fb","Paris Saint-Germain"],
        ["a2632411-2914-4dfd-a3c9-5e0a1b55faf9","Olympique de Marseille"],
        ["b048e2ae-2875-4949-8bd5-e254fbe0ebfb","Monaco"],
        ["ce8e010a-984c-4254-936e-b40fa9d4661d","Lyon"],
        ["7642971a-9300-44b0-87af-caf348d45cdc","Benfica"],
        ["451a3868-0f0c-4ba7-8e42-d64ead2d2dee","Porto"],
        ["9d465afc-7846-4cbc-b551-11867896ea5d","Sporting"],
        ["2c12361c-5964-4014-99b6-a729ff690000","Braga"],
        ["081f52ef-ad56-47a5-aa4d-939f891370e5","Ajax"],
        ["80cd91d5-a45c-4bba-8015-86adae7cc4b8","PSV"],
        ["d6c8e32b-6e66-46aa-9efb-564bea78de8b","Feyenoord"],
        ["3453f1f4-2bcb-4241-8b3e-e184f6802963","Galatasaray"],
        ["b6a1230a-60fa-484f-bf37-21e14405c5d7","Fenerbahçe"],
        ["9e3d9652-d476-43a9-bfb7-e99bba891294","Beşiktaş"],
        ["fe555b7c-6fb5-474f-b58f-73a297be0c25","Celtic"],
        ["d3c0cfff-704f-461f-a7da-f65e0898eb0b","Rangers"],
        ["d1d61831-69ba-415c-a0e1-43379c1b8ac9","Club Brugge"],
        ["a0ff081f-15f7-4aac-96c5-e5b16388f451","Anderlecht"]
    ];
    ...
    /* =====================================================
       CHAMPIONS LEAGUE — CLUBES
       ===================================================== */

    function populateChampionsClubSelect() {
        ...
        dom.championsTeam.disabled = false;

        if (
            dom.championsTeamStatus
        ) {
            dom.championsTeamStatus.textContent =
                "32 clubes disponíveis para a Season 01.";
        }

        loadChampionsOccupiedClubs();

    }


    async function loadChampionsOccupiedClubs() {
        ...
        try {
            ...
            const {
                ...
                await client
                    ...
                    .select(
                        "championship_club_id,participant_id,status"
                    )
                    .eq(
                        "championship_id",
                        CHAMPIONS_SEASON_ID
            ...
            if (
                ...
                const available =
                    CHAMPIONS_CLUBS.length -
                    occupied.size;

                dom.championsTeamStatus.textContent =
                    `${available} clubes disponíveis • ${occupied.size} ocupados.`;
